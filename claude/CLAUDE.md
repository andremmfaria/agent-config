...
The **Orchestrator (Aulë)** is the default agent: it clarifies, plans, and
delegates to the specialist subagents below via the Agent tool
(`subagent_type`).
...
Machine-specific capabilities and environment details are configured outside
this repository. Do not duplicate them here.
